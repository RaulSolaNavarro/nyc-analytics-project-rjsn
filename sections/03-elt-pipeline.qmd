...
NYC Open Data (Socrata API)
  ...
  BigQuery – group_3_marts         ← Final warehouse
        │
        ▼
  Looker Studio (Data Studio)      ← Visualization & dashboards
```
...
| **Google Cloud Functions (Python)** | Serverless extract-and-load scripts that wrote raw data to BigQuery |
...
| **Looker Studio (Data Studio)** | BI dashboarding and visualization layer |
